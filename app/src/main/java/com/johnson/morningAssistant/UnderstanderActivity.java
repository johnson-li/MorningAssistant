...
public class UnderstanderActivity extends Activity implements OnClickListener{
	...
	private void initLayout(){
		...
		mSharedPreferences = getSharedPreferences("adsf", Activity.MODE_PRIVATE);
	}
...
//			Intent intent = new Intent(UnderstanderActivity.this, UnderstanderSettings.class);
